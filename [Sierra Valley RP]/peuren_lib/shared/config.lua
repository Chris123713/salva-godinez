...
Config.DispatchResource = "rcore_dispatch" -- The dispatch system resource folder name
...
Config.Fuel = "rcore_fuel"
Config.FuelResource = "rcore_fuel" -- The fuel system resource folder name
...
Config.VehicleKeysResource = "qbx_vehiclekeys" -- The vehicle key system resource folder name
...
Config.ClothingResource = "rcore_clothing" -- The clothing system resource folder name
