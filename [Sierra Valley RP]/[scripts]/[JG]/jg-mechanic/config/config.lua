...
Config.SocietyBanking = "tgg-banking" -- or "okokBanking", "fd_banking", "Renewed-Banking", "tgg-banking", "qb-banking", "qb-management", "esx_addonaccount"
...
-- Servicing
Config.EnableVehicleServicing = false -- DISABLED - no mechanic shop required for repairs
...
-- Repairs
-- Allow vehicle fixing at owner-owned mechanic shops even if no employees are currently on duty.
-- Set to `true` so owners can repair vehicles at their owned mechanic locations.
Config.AllowFixingAtOwnedMechanicsIfNoOneOnDuty = true
-- Allow duct tape / emergency repair to be applied for any small amount
-- of engine damage. GTA engine health typically ranges up to 1000,
-- so increase these so the item will be usable for slight damage and
-- provide a full temporary restart when applied.
Config.DuctTapeMinimumEngineHealth = 1000.0
Config.DuctTapeEngineHealthIncrease = 1000.0
...
Config.MechanicLocations = {
  bennys = {
    type = "owned",  -- Owned and job-locked to bennys
    job = "bennys",  -- Job-locked to bennys mechanics only
    jobManagementRanks = {},  -- Empty = no one can access management (disables boss menu)
    logo = "bennys.png", -- logos go in /logos
    commission = 0, -- No commission (set to 0 to disable)
    locations = {
      {
  ...
  lscustoms = {
    ...
    locations = {
      {
        coords = vector4(-341.550079, -146.242416, 39.009689, 251.405685),
        size = 3.0,
        showBlip = true,
      }
    },
  ...
  bennys_selfservice = {
    ...
    locations = {
      {
        coords = vector4(-222.057724, -1326.307861, 30.890442, 90.902008),
        size = 3.0,
        showBlip = true,
      }
    },
  ...
  tm_mechanic = {
    type = "owned",
    job = "tm_mechanic", -- job-locked to the TM mechanic shop
    jobManagementRanks = {},
    logo = "tm.png",
    commission = 0,
    locations = {
      {
        coords = vector3(63.249348, 6537.978516, 31.701664), -- set to TM mechanic shop coords
        size = 8.0,
        showBlip = true,
      },
      {
        coords = vector4(63.249348, 6537.978516, 31.701664, 135.955429), -- self-service location (employee only)
        size = 3.0,
        showBlip = true,
        employeeOnly = true,
      }
...
,
    ...
    locations = {
      {
        coords = vector4(-1588.0963, -832.5768, 10.1127, 143.1842),
        size = 3.0,
        showBlip = true,
      }
    },
...
-- self-service location merged into `tm_mechanic` above to avoid duplicate category
