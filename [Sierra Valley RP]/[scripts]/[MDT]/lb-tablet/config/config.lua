...
Config.DatabaseChecker.Enabled = false -- DISABLED: databaseChecker.lua is corrupted - restore from backup
...
Config.BaseDispatch.Actions = {
    ...
    CarJacking = {
        police = true,
        ambulance = false,
        cooldown = 22,        -- ~22 seconds per player (was 15-30 range)
        serverCooldown = 22,  -- ~22 seconds server-wide
        dispatch = {
            priority = "high",  -- Carjacking is a violent crime
            time = 180,         -- 3 minutes visibility
        },
    },
    VehicleTheft = {
        police = true,
        ambulance = false,
        cooldown = 37,        -- ~37 seconds per player (was 30-45 range)
        serverCooldown = 37,  -- ~37 seconds server-wide
        dispatch = {
            priority = "medium",
            time = 180,         -- 3 minutes visibility
        },
...
Config.Locations = { -- Locations that'll appear in the maps app
    ...
    {
        position = vector2(-1088.584595, -813.173462),
        name = "Vespucci",
        description = "Vespucci Police Department",
        icon = "https://cdn-icons-png.flaticon.com/512/7211/7211100.png",
    },	
    {
        position = vector2(-444.768951, 6020.234375),
        name = "Paleto Sheriff's Office",
        description = "Paleto Bay Sheriff's Office (LSCSO)",
        icon = "https://cdn-icons-png.flaticon.com/512/7211/7211100.png",
    },
    {
...
Config.Police.Permissions = {
    ...
    ["police"] = {
        ...
        warrant = {
            create = 3,  -- Officer (first full-time rank)
            edit = 3,    -- Officer
            delete = 11, -- Commander (admin only)
            view = 1
        },
        offence = {
            create = 1,
        ...
        bulletin = {
            create = 11,
            pin = 11,
            delete = 11, -- you are always able to delete your own bulletins
            edit = 11, -- you can always edit your own bulletins
            view = 1
        },
        stash = {
            view = 1,
    ...
    ["lscso"] = {
        ...
        warrant = {
            create = 2,  -- Deputy (first full-time rank)
            edit = 2,    -- Deputy
            delete = 11, -- Assistant Chief Deputy (admin only)
            view = 1
        },
        offence = {
            create = 1,
    ...
    ["sasp"] = {
        ...
        warrant = {
            create = 2,  -- Trooper (first full-time rank)
            edit = 2,    -- Trooper
            delete = 11, -- Assistant Chief (admin only)
            view = 1
        },
        offence = {
            create = 1,
