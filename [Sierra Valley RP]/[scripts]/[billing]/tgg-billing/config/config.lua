...
Config.Banking = 'tgg-banking' -- Options: auto, default, tgg-banking, okokBanking, renewed-banking, snipe-banking, mBanking, s1n_banking, fd_banking
--[[
...
-- Key to open quick create invoice. Default: F8
-- https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
Config.QuickCreateInvoiceKey = 'F9'

-- Used for notifications
-- options: auto, yflip-phone, yphone, yseries, custom
Config.PhoneResourceName = "lb phone"
