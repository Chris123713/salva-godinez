...
-- Main theme colors for the billing UI
Config.PrimaryColor = '#1e88e5'   -- Default blue (primary color)
Config.SecondaryColor = '#673ab7' -- Default purple (secondary color)

-- Background colors for the billing UI
Config.BackgroundMain = '#161a2f'      -- Main background (section wrapper) - darker blue-gray
Config.BackgroundSecondary = '#0f1327' -- Secondary background (content wrapper) - darkest blue-gray
