...
exports('CreateInvoice', function(invoiceData)
    lib.print.warn(
    '[tgg-billing] Client-side CreateInvoice export is deprecated. Please use the server-side export instead: https://docs.teamsgg.dev/paid-scripts/billing/exports/server-side#createinvoice')
    return nil
end)
