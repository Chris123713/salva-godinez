...
ALTER TABLE jobs ADD `money` INT NOT NULL DEFAULT 0;
ALTER TABLE jobs ADD `black_money` INT NOT NULL DEFAULT 0;
ALTER TABLE jobs ADD `inventory` varchar(2500) NOT NULL DEFAULT '{}';
ALTER TABLE jobs ADD `earning` INT NOT NULL DEFAULT 0;
