...
-- Add LSC SO as a callable company so players can call the Sheriff's Office
table.insert(Config.Companies.Services, {
    job = "lscso",
    name = "LSC SO",
    icon = "https://cdn-icons-png.flaticon.com/512/3050/3050653.png",
    canCall = true,
    canMessage = true,
    bossRanks = { "boss" },
    location = {
...
Config.Companies.Contacts = { -- not needed if you use the services app, this will add the contact to the contacts app
    ...
    ["lscso"] = {
        name = "LSC SO",
        photo = "https://cdn-icons-png.flaticon.com/512/3050/3050653.png"
    },
}
