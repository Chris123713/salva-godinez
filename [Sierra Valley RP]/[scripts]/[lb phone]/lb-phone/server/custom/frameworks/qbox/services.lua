...
function RefreshCompanies()
    if Config.QBOldJobMethod then
        ...
        for _, v in pairs(players) do
            local player = type(v) == "table" and v or QB.Functions.GetPlayer(v)

            if not player or not player.PlayerData or not player.PlayerData.job or not player.PlayerData.job.onduty then
                goto continue
            end
