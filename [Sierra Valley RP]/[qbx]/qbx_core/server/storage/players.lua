...
local function fetchPlayerGroups(citizenid)
    ...
    for i = 1, #groups do
        ...
        local validGroup = group.type == GroupType.JOB and jobs[group.group] or gangs[group.group]
        ...
        elseif group.type == GroupType.JOB then
            playerJobs[group.group] = group.grade
        elseif group.type == GroupType.GANG then
            playerGangs[group.group] = group.grade
        end
    end
    return playerJobs, playerGangs
end
