...
AddEventHandler('playerDropped', function(reason)
    ...
    if not QBX or not QBX.Players or not QBX.Players[src] then return end
...
AddEventHandler('onResourceStart', function(resource)
    ...
    local userIdExists = MySQL.single.await([[
    ...
    if not userIdExists or userIdExists.count == 0 then
        MySQL.query([[
            ALTER TABLE `players`
