return {
    ...
    money = {
        ...
        ---@type Money
        moneyTypes = { cash = 500, bank = 10000, crypto = 0 }, -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
    ...
    characterDataTables = {
        {'properties', 'owner'},
        -- {'bank_accounts_new', 'id'}, -- Table does not exist, commented out
        {'playerskins', 'citizenid'},
        {'player_mails', 'citizenid'},
        -- {'player_outfits', 'citizenid'}, -- Table does not exist, commented out
