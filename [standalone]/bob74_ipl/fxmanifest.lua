...
client_scripts {
    ...
    --, "gtav/ammunations.lua"  -- Missing file
    , "gtav/bahama.lua"
    , "gtav/cargoship.lua"
    , "gtav/floyd.lua"
    , "gtav/franklin.lua"
    ...
    , "gtav/graffitis.lua"
    --, "gtav/pillbox_hospital.lua"  -- Missing file
    ...
    --, "dlc_casino/casino.lua"  -- Missing file
    --, "dlc_casino/penthouse.lua"  -- Missing file
    --, "dlc_casino/arcade.lua"  -- Missing file
    --, "dlc_casino/arcade_basement.lua"  -- Missing file
