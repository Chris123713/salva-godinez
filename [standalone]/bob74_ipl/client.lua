CreateThread(function()
    ...
    -- PillboxHospital.Enable(true) -- Disabled: file gtav/pillbox_hospital.lua does not exist

    -- Zancudo Gates (GTAO like): -1600.30100000, 2806.73100000, 18.79683000
    ZancudoGates.LoadDefault()

    -- Other
    -- Ammunations.LoadDefault()  -- Missing file: gtav/ammunations.lua
    ...
    -- ====================================================================
    -- Commented out - casino files not included
